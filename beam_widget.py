...
class BeamWidget(DrawWidget):
    ...
    def draw_loads(self):
        # Draw loads
        self.stroke_color = 'rgba(128, 50, 50, 1.0)'
        self.fill_color = 'rgba(128, 50, 50, 0.2)'
        self.stroke_width = 2.0
        self.text_color = 'rgba(128, 50, 50, 1.0)'
    ...
    def draw_displacement(self):
        # Draw displacements
        self.stroke_color = 'rgba(128, 50, 50, 1.0)'
        self.fill_color = 'rgba(128, 50, 50, 0.25)'
        self.stroke_width = 2.0
    ...
    def draw_moments(self):
        ...
        # Draw moments
        self.stroke_color = 'rgba(50, 128, 50, 1.0)'
        self.fill_color = 'rgba(50, 128, 50, 0.25)'
        self.stroke_width = 2.0
        ...
        self.polygon(points.tolist())

    def draw_section_force(self):

        # Draw moments
        self.stroke_color = 'rgba(50, 50, 128, 1.0)'
        self.fill_color = 'rgba(50, 50, 128, 0.25)'
        self.stroke_width = 2.0
...
if __name__ == "__main__":
    model = BeamModel()
    widget = BeamWidget(model)
    widget.show_dimensions = True
    widget.show_loads = True
    widget.show_displacement = False
    widget.show_moments = False
    widget.show_section_force = False
    widget.draw()
